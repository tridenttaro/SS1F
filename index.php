...
?>
            ...
            <ul class="example">
                <?php if ($page != 1){?>
                <li><?php echo '<a href="' . "index.php" . '?page=' . ($page - 1) . '">前へ</a>'; ?></li><?php } else { ?>
                <?php } ?>
                <?php if ($page > 2){?>
                <li><?php echo '<a href="' . "index.php" . '?page=' . ($page - 2) . '">'. ($page - 2) .'</a>'; ?></li><?php } ?>
                <?php if ($page > 1){?>
                <li><?php echo '<a href="' . "index.php" . '?page=' . ($page - 1) . '">'. ($page - 1) .'</a>'; ?></li><?php } if($coun_th != 0){ ?>
                <li class="this"><?php echo $page.'</a>'; ?></li><?php } 
                if ($page < ceil($coun_th/$page_num )  ){?>
                <li><?php echo '<a href="' . "index.php" . '?page=' . ($page + 1) . '">'. ($page + 1) .'</a>'; ?></li><?php }
                if ($page < ceil($coun_th/$page_num ) - 1 ){ ?>
                <li><?php echo '<a href="' . "index.php" . '?page=' . ($page + 2) . '">'. ($page + 2) .'</a>'; ?></li><?php } 
                if (($page != ceil($coun_th/$page_num ))&&($coun_th != 0)) {?>
                <li><?php echo '<a href="' . "index.php" . '?page=' . ($page + 1) . '">次へ</a>'; ?></li><?php } else { ?>
            <?php } ?>
